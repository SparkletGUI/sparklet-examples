Project: Coffee Maker – RA8D1 (800×480)
Version: 1.0

This project contains a Coffee Maker demo designed to run on the Renesas RA8D1 platform using the Flint UI Designer tool.
...
![Coffee Maker UI](./resources/images/coffee_menu1.png)
