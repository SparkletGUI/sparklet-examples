iMxRT1170 Digital Cluster Demo (1280×720)
-----------------------------------------
Version: 1.0
------------

This project contains a Digital Cluster demo designed to run on the NXP iMxRT1170 platform using the Flint UI Designer tool.
It includes UI assets, project files, and documentation to help developers quickly evaluate Sparklet.
...
- Open Screen Layouts.
- Click screens like Home, Menu etc.
...
![Digital Cluster](./resources/images/modern_ref.png)
