Smart Door Lock Demo – RA8D1 (800×480)
----------------------------------
Version: 1.0
-------------

This project contains a Smart Door Lock UI demo designed to run on the RA8D1 platform using the Flint UI Designer tool.
...
The following screenshot shows the main UI of the Smart Door Lock UI demo:

![Smart Door Lock UI](./resources/images/main_ref.png)
