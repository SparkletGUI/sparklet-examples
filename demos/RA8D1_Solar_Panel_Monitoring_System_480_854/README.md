Solar Panel Monitoring System– RA8D1 (480×854)
----------------------------------
Version: 1.0
-------------

This project contains a Solar Panel Monitoring System demo designed to run on the Renesas RA8D1 platform using the Flint UI Designer tool.
...
- Open Screen Layouts.
- Click screens like main_screen.
- Review widgets (images, buttons,dial, progress bars etc.)
...
The following screenshot shows the main UI of the Solar Panel Monitoring System demo:

![Solar Panel Monitoring System UI](./resources/images/solar_panel_bg_ref.png)
...
- Flint UI Designer doc : https://sparkletui.com/flint-ui-designer
