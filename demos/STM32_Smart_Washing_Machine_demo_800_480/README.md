Smart Washing Machine UI Demo – STM32 (800×480)
----------------------------------
Version: 1.0
-------------

This project contains a Smart Washing Machine UI demo designed to run on the STM32 platform using the Flint UI Designer tool.
...
The following screenshot shows the main UI of the Smart Washing Machine UI demo:

![Smart Washing Machine UI](./resources/images/main_ref.png)
