3D-Printer UI Demo – RA8D1 (480×854)
----------------------------------
Version: 1.0
-------------

This project contains a modern 3D-Printer UI demo designed to run on the Renesas RA8D1 platform using the Flint UI Designer tool.
...
The following screenshot shows the main UI of the 3D-Printer UI demo:

![3D-Printer UI](./resources/images/3d_printer_bg.png)
